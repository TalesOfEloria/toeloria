        ...
        if (this.type === "Skills") {
            ...
            if ( roll.total >= skilldiff ) {
				...
				if ( anwendungsstufe > manaressourcen ) {
					...
					return `${label} <span style="color: red; font-size:16px; text-decoration: underline; text-decoration-thickness: 2px">Misserfolg</span> <span style="color: black">weil zu wenig Mana (diff: ${skilldiff})</span>`
				}
				else {
					...
					return `${label} <span style="color: green; font-size:16px; text-decoration: underline; text-decoration-thickness: 2px">Erfolg</span> <span style="color: black">(diff: ${skilldiff})</span>`
				}
				...
				if ( anwendungsstufe > manaressourcen ) {
					...
					return `${label} <span style="color: red; font-size:16px; text-decoration: underline; text-decoration-thickness: 2px">Misserfolg</span> <span style="color: black">und zu wenig Mana (diff: ${skilldiff})</span>`
				}
				else {
					let manaburn = Number(manaressourcen) - Number(anwendungsstufe);
					console.log("manaburn = ", manaburn);
					...
					return `${label} <span style="color: red; font-size:16px; text-decoration: underline; text-decoration-thickness: 2px">Misserfolg</span> <span style="color: black">(diff: ${skilldiff})</span>`
				}
            }
        }
    }
